...
var Bebop = module.exports = function(opts) {
  ...
  this.rtpStreamPort = opts.rtpStreamPort || 55004;
  this.rtpControlPort = opts.rtpControlPort || 55005;
...
Bebop.prototype.discover = function(callback) {
  this._discoveryClient.connect(this.discoveryPort, this.ip, function() {
    this._discoveryClient.write(JSON.stringify({
      ...
      "arstream2_client_stream_port": this.rtpStreamPort.toString(),
      "arstream2_client_control_port": this.rtpControlPort.toString()
    }));
  }.bind(this));
